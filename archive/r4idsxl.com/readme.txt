# Installation instructions for YSMenu on r4idsxl.com carts
...
4. Make a copy of `TTMenu.dat`, then rename this copy to `R4i.DL`

Cheats:
    - YSMenu: TTMenu/usrcheat.dat
    - r4idsxl.com Kernel 1.6 (old): SYSTEM/usrcheat.dat